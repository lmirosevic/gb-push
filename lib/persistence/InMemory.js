...
var inMemoryPersistence = module.exports = {
  setChannelSubscriptionStatus: function(pushToken, channel, subscriptionStatus, callback) {
  ...
  subscribedChannels: function(pushToken, range, callback) {
    p.verifyToken_s(pushToken);
  ...
  subscriptionStatus: function(pushToken, channel, callback) {
    p.verifyToken_s(pushToken);
    toolbox.requiredArguments(channel);
